...
exitiputtest(void)
{
  ...
  pid = fork(DEFAULT_TCK);
     216:	c7 04 24 1e 00 00 00 	movl   $0x1e,(%esp)
...
preempt(void)
{
  ...
  pid1 = fork(DEFAULT_TCK);
     bd5:	c7 04 24 1e 00 00 00 	movl   $0x1e,(%esp)
  ...
  pid3 = fork(DEFAULT_TCK);
     c0d:	c7 04 24 1e 00 00 00 	movl   $0x1e,(%esp)
...
mem(void)
{
  ...
  if((pid = fork(DEFAULT_TCK)) == 0){
     dba:	c7 04 24 1e 00 00 00 	movl   $0x1e,(%esp)
{
  void *m1, *m2;
  int pid, ppid;
...
fourfiles(void)
{
  ...
  for(pi = 0; pi < 4; pi++){
    ...
    pid = fork(DEFAULT_TCK);
    1074:	c7 04 24 1e 00 00 00 	movl   $0x1e,(%esp)
...
concreate(void)
{
  ...
  for(i = 0; i < 40; i++){
    ...
    pid = fork(DEFAULT_TCK);
    187c:	c7 04 24 1e 00 00 00 	movl   $0x1e,(%esp)
...
linkunlink()
{
  ...
  pid = fork(DEFAULT_TCK);
    1b41:	c7 04 24 1e 00 00 00 	movl   $0x1e,(%esp)
...
#define BIG (100*1024*1024)
  ...
  *lastaddr = 99;
  ...
  for(i = 0; i < sizeof(pids)/sizeof(pids[0]); i++){
    if((pids[i] = fork(DEFAULT_TCK)) == 0){
    2f84:	83 ec 0c             	sub    $0xc,%esp
    2f87:	6a 1e                	push   $0x1e
...
bigargtest(void)
{
  ...
  pid = fork(DEFAULT_TCK);
    3320:	c7 04 24 1e 00 00 00 	movl   $0x1e,(%esp)
...
uio()
{
  ...
  pid = fork(DEFAULT_TCK);
    3622:	c7 04 24 1e 00 00 00 	movl   $0x1e,(%esp)
