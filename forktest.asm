...
printf(int fd, char *s, ...)
{
  ...
  cb:	68 76 04 00 00       	push   $0x476
  d0:	e8 0b 01 00 00       	call   1e0 <strlen>
  d5:	83 c4 0c             	add    $0xc,%esp
  d8:	50                   	push   %eax
  d9:	68 76 04 00 00       	push   $0x476
  de:	6a 01                	push   $0x1
...
printf(int fd, char *s, ...)
{
  ...
  f3:	68 84 04 00 00       	push   $0x484
  f8:	e8 e3 00 00 00       	call   1e0 <strlen>
  fd:	83 c4 0c             	add    $0xc,%esp
 100:	50                   	push   %eax
 101:	68 84 04 00 00       	push   $0x484
 106:	6a 01                	push   $0x1
...
printf(int fd, char *s, ...)
{
 ...
 11a:	68 4f 04 00 00       	push   $0x44f
 11f:	e8 bc 00 00 00       	call   1e0 <strlen>
 124:	83 c4 0c             	add    $0xc,%esp
 127:	50                   	push   %eax
 128:	68 4f 04 00 00       	push   $0x44f
 12d:	6a 01                	push   $0x1
...
printf(int fd, char *s, ...)
{
 ...
 13c:	68 63 04 00 00       	push   $0x463
 141:	e8 9a 00 00 00       	call   1e0 <strlen>
 146:	83 c4 0c             	add    $0xc,%esp
 149:	50                   	push   %eax
 14a:	68 63 04 00 00       	push   $0x463
 14f:	6a 01                	push   $0x1
